...
from .serializer import GradeSerializer, StudentSerializer, CourseSerializer, ProfessorSerializer, ScheduleSerializer, UsersSerializer
from .models import Grade, Student, Course, Professor, Schedule, Users
